          ...
          <div class="w-form">
            <form action="" method="post">
              <div>
                ...
                <input class="w-input input-form" id="email" type="email" name="email" data-name="email" required="required" autocomplete="off" value="admin@admin.com">
                <div class="separator-fields"></div>
              </div>
              <div>
                <label class="label-form" for="email">PASSWORD</label>
                <div class="w-clearfix block-input-combined">
                  <input class="w-input input-form left" id="password" type="password" name="password" data-name="password" required="required" autocomplete="off" value="admin"><!--<a class="right-input-link" href="forgot.html" data-load="1">Forgot Password</a>-->
                </div>
