...
?>
<div class="encounter bg-white" style="padding-right:20px;">
<div class="row">
			...
			<div class="panel panel-default bg-grey">
				...
				<div class="panel-body text-center" style="padding:20px;">
					<div id="encounter_gift_container">
						<img src="<?=$system->getDomain()?>/img/gifts/12.png" class="img-responsive" style="height:70px;width:80px;">
						<a href="#" data-toggle="modal" data-target="#send-gift" class="btn btn-circle btn-default btn-xs btn-fill encounter_gift_button"> <i class="ti-plus"></i> </a>
					</div>
				</div>
			</div>
		</div>
